...
# Remove old unfolded-circle-system-monitor.tar.gz if it exists
rm -f ./unfolded-circle-system-monitor.tar.gz
...
# Run dotnet publish
echo "Publish"
dotnet publish ./src/UnfoldedCircle.SystemMonitor/UnfoldedCircle.SystemMonitor.csproj -c Release -p:BuildForLinuxArm=true -o ./publish
...
cd ./driverdir || exit
tar -czvf ../../unfolded-circle-system-monitor.tar.gz ./*
