# Unfolded Circle System Monitor Integration Driver

[![Release](https://img.shields.io/github/actions/workflow/status/henrikwidlund/unfoldedcircle-systemmonitor/github-release.yml?label=Release&logo=github)](https://github.com/henrikwidlund/unfoldedcircle-systemmonitor/actions/workflows/github-release.yml)
[![CI](https://img.shields.io/github/actions/workflow/status/henrikwidlund/unfoldedcircle-systemmonitor/ci.yml?label=CI&logo=github)](https://github.com/henrikwidlund/unfoldedcircle-systemmonitor/actions/workflows/ci.yml)
![Sonar Quality Gate](https://img.shields.io/sonar/quality_gate/henrikwidlund_unfoldedcircle-systemmonitor?server=https%3A%2F%2Fsonarcloud.io&label=Sonar%20Quality%20Gate&logo=sonarqube)
[![Qodana](https://img.shields.io/github/actions/workflow/status/henrikwidlund/unfoldedcircle-systemmonitor/qodana_code_quality.yml?branch=main&label=Qodana&logo=github)](https://github.com/henrikwidlund/unfoldedcircle-systemmonitor/actions/workflows/qodana_code_quality.yml)

This repository contains the server code for hosting a system monitor integration driver for the Unfolded Circle Remotes.
...
1. Download `unfolded-circle-system-monitor-[version]-remote.tar.gz` from the release page
2. Open the remote's Web Configurator
3. Click on `Integrations`
4. Click on `Add new` and then `Install custom`
5. Choose the file in step 1 (`unfolded-circle-system-monitor-[version]-remote.tar.gz`)
6. Click on the newly installed integration and complete the setup
...
- `Logging__LogLevel__UnfoldedCircle.SystemMonitor` = `Information`
...
- This driver is only intended to run on the remote itself
